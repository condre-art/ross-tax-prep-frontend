    ...
    <main>
      <section className="bg-navy text-cream py-20 text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg">
          Bank products, refund allocation, and client-facing flows purpose-built for compliance.
        </p>
        <div className="mt-8 flex justify-center gap-4 flex-wrap">
          <a
            href="/app/bank-products"
            className="inline-block bg-gold text-navy px-6 py-3 font-semibold rounded shadow"
          >
            Bank Products Flow
          </a>
          <a
            href="/app/refund-allocation"
            className="inline-block bg-cream text-navy px-6 py-3 font-semibold rounded border border-cream/50"
          >
            Refund Allocation
          </a>
        </div>
      ...
      <section className="py-16 max-w-6xl mx-auto grid md:grid-cols-3 gap-6 px-6">
        <SectionCard
          title="Bank Products"
